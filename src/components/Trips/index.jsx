  ...
  {benefits.map((item, index) => (
   ...
   <div className=''>
    ...
    <div className='w-full h-[115rem] sm:h-[180rem] mt-[30px] sm:mt-0 relative'>
        <img loading="lazy" src="/trips/day1.webp" alt="" className='w-[40%] sm:w-full absolute right-0'/>
        ...
        <div className="w-[22%]  absolute top-[20%] sm:w-full sm:top-[28%] left-[4%] flex flex-col gap-2  ">
                    ...
                    <img loading="lazy" src="/trips/day3.webp" alt="" className='absolute top-[38%] left-[0] sm:w-full sm:top-[33%]  ' />
                    <img loading="lazy" src="/trips/day5.webp" alt="" className='absolute bottom-[12%] left-[0] sm:w-full sm:bottom-[36%]' />
                    <img loading="lazy" src="/trips/day6.webp" alt="" className='absolute bottom-[0%] right-[0] sm:w-full sm:bottom-[15%]' />
...
<div className="w-[22%] sm:w-full sm:left-4 sm:bottom-[0%]  absolute bottom-[25%] right-[34%] flex flex-col gap-2  ">
